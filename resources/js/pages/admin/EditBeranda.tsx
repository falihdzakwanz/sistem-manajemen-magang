                        ...
                        {strukturOrganisasi.map((item) => {
                            ...
                            const getItemConfig = (key: string) => {
                                const configs: Record<string, { displayName: string; category: string; bgColor: string; badgeColor: string }> = {
                                    ...
                                    kasubag_umum: {
                                        displayName: 'Kasubag Umum & Kepegawaian',
                                        category: 'Sub Bagian',
                                        bgColor: 'bg-green-50',
                                        badgeColor: 'bg-green-100 text-green-600',
                                    },
                                    kasubag_keuangan: {
                                        displayName: 'Kasubag Keuangan & Aset',
                                        category: 'Sub Bagian',
                                        bgColor: 'bg-green-50',
                                        badgeColor: 'bg-green-100 text-green-600',
                                    },
                                    ...
                                    perencana_ahli_muda: {
                                        displayName: 'Perencana Ahli Muda',
                                        category: 'Jabatan Fungsional',
                                        bgColor: 'bg-teal-50',
                                        badgeColor: 'bg-teal-100 text-teal-600',
                                    },
                                    kabid_informasi: {
                                        displayName: 'Kabid Informasi & Kominfo',
                                        category: 'Kepala Bidang',
                                        bgColor: 'bg-orange-50',
                                        badgeColor: 'bg-orange-100 text-orange-600',
                                    },
                                    kabid_egovernment: {
                                        displayName: 'Kabid E-Government',
                                        category: 'Kepala Bidang',
                                        bgColor: 'bg-orange-50',
                                        badgeColor: 'bg-orange-100 text-orange-600',
                                    },
