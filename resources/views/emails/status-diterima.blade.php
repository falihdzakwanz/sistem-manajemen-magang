...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <div style="height: 2px; background: linear-gradient(90deg, #10b981, #059669); margin: 30px 0;"></div>

            <div style="background: #ecfdf5; border-radius: 8px; padding: 20px; margin: 20px 0; border-left: 4px solid #10b981;">
                <h3 style="color: #065f46; margin: 0 0 15px;">🎯 Tips Sukses Magang</h3>
                <ul style="margin: 0; padding-left: 20px; color: #047857;">
                    <li>Tunjukkan antusiasme dan inisiatif dalam setiap tugas</li>
                    <li>Aktif bertanya dan belajar dari mentor dan rekan kerja</li>
                    <li>Dokumentasikan setiap pembelajaran dan pencapaian</li>
                    <li>Jaringan dengan profesional di bidang yang diminati</li>
                </ul>
            </div>
        </div>
